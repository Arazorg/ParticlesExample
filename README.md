...
T - в данном случае классы хранящие инициализирующую информацию,(тип, позиция и т.д.) для партиклов, необходимые им для создания.<br /> 
...
В данном случае логика регистрации будет немного отличаться, так как за регистрацию бонусов отвечает отдельный класс(BonusesRegistrar), ввиду того, что необходимо регистрировать бонусы в разных сервисах, сути это не меняет.<br />
